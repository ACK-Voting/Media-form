...
const ministriesLinks = [
  ...
  { label: "Anglican Women's Fellowship (AWF)", href: '/ministries/awf' },
  { label: "Mother's Union", href: '/ministries/mothers-union' },
  { label: "Anglican Men's Fellowship (AMF)", href: '/ministries/amf' },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-18 py-3">
          ...
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <div>
              <p className="text-blue-900 font-bold text-base leading-tight">ACK Mombasa Memorial Cathedral</p>
          ...
          <div className="hidden lg:flex items-center gap-6">
            ...
            <div className="relative group">
              <button className={`text-sm font-medium flex items-center gap-1 transition-colors text-gray-700 hover:text-blue-900 ${pathname.startsWith('/about') || pathname === '/history' || pathname === '/gallery' || pathname === '/staff' ? 'text-blue-900 font-semibold' : ''}`}>
                About
            ...
            {/* Ministries Dropdown */}
            <div className="relative group">
              <button className={`text-sm font-medium flex items-center gap-1 transition-colors text-gray-700 hover:text-blue-900 ${pathname.startsWith('/ministries') ? 'text-blue-900 font-semibold' : ''}`}>
                Ministries
                <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                </svg>
            ...
            <Link href="/get-involved" className={`text-sm font-medium transition-colors ${isActive('/get-involved') ? 'text-blue-900 font-semibold' : 'text-gray-700 hover:text-blue-900'}`}>
              Get Involved
            </Link>

            <Link href="/contact" className={`text-sm font-medium transition-colors ${isActive('/contact') ? 'text-blue-900 font-semibold' : 'text-gray-700 hover:text-blue-900'}`}>
              Contact
            </Link>
