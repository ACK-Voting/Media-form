    ...
    return (
      <div className="min-h-screen bg-white">
        ...
        <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
          ...
          <Link href="/mockup/ministries" className="bg-blue-700 text-white px-6 py-3 rounded-xl font-medium hover:bg-blue-800 transition-colors">
            All Ministries
          </Link>
        </div>
        <Footer />
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className={`relative bg-gradient-to-br ${ministry.color} pt-24 pb-0`}>
        <div className="max-w-6xl mx-auto px-4 pb-16 text-white">
          <Link href="/mockup/ministries" className="inline-flex items-center gap-2 text-white/70 hover:text-white text-sm mb-6 group">
            ...
            {ministryPostsList.length > 0 ? (
              <div className="space-y-5">
                {ministryPostsList.map((post) => (
                  <Link key={post.id} href={`/mockup/ministries/${slug}/updates/${post.slug}`}>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-5">
            {otherMinistries.map((m) => (
              <Link key={m.slug} href={`/mockup/ministries/${m.slug}`}>
