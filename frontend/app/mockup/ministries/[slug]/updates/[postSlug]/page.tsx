    ...
    return (
      <div className="min-h-screen bg-white">
        ...
        <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
          ...
          <Link href={`/mockup/ministries/${slug}`} className="bg-blue-700 text-white px-6 py-3 rounded-xl font-medium hover:bg-blue-800 transition-colors">
            Back to Ministry
          </Link>
        </div>
        <Footer />
      ...
      <div className={`relative bg-gradient-to-br ${ministry.color} pt-24 pb-12 px-4`}>
        <div className="max-w-3xl mx-auto text-white">
          <div className="flex items-center gap-2 mb-4">
            <Link href={`/mockup/ministries/${slug}`} className="text-white/70 hover:text-white text-sm flex items-center gap-1 group">
        ...
        {related.length > 0 && (
          <div className="mt-12">
            ...
            <div className="space-y-3">
              {related.map((rel) => (
                <Link key={rel.id} href={`/mockup/ministries/${slug}/updates/${rel.slug}`}>
