...
const SECTION_TITLES: Record<string, { title: string; subtitle: string }> = {
  ...
  '/cms/finance': { title: 'Financial Ledger', subtitle: 'Record cathedral income and expenditure' },
};
...
function CMSSidebar({ mobileOpen, setMobileOpen }: { mobileOpen: boolean; setMobileOpen: (open: boolean) => void }) {
  ...
  const { can, canMinistry, isMinistryOnly, isSuperAdmin, ministryAccess } = useCMSPermissions();
        ...
        <nav className="flex-1 px-3 py-4 space-y-1 overflow-y-auto custom-scrollbar">
          ...
          {!isMinistryOnly && (
            <>
              ...
              {/* Super admin only. Editing the giving page is church-admin work;
                  the record of money received and spent is narrower than that. */}
              {isSuperAdmin && navItem('/cms/finance', 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z', 'Finance')}
