    ...
    return (
        <>
            ...
            <div className="lg:hidden fixed top-0 left-0 right-0 z-30 bg-white border-b border-gray-200 px-4 py-3 flex items-center justify-between">
                ...
                <h1 className="font-semibold text-gray-900">Media Team Portal</h1>
                <div className="w-10" />
            </div>
            ...
            >
                ...
                <div className="h-16 flex items-center gap-3 px-5 border-b border-gray-200">
                    ...
                    <div>
                        <h2 className="font-bold text-gray-900 text-sm leading-tight">ACK Media</h2>
                ...
                <div className="border-t border-gray-200 p-4">
                    <div className="flex items-center gap-3 mb-3">
                        <div className="w-9 h-9 bg-gradient-to-br from-purple-400 to-indigo-500 rounded-full flex items-center justify-center text-white font-semibold text-sm">
