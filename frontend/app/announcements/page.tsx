  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        {featured && activeCategory === 'All' && !search && (
          <div className="mb-12">
            ...
            <Link href={`/announcements/${featured.slug}`}>
        ...
        {filtered.length > 0 ? (
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filtered.map((post) => (
              <Link key={post.id} href={`/announcements/${post.slug}`}>
      ...
      <section className="bg-gradient-to-r from-blue-900 to-indigo-900 py-16 px-4 text-center text-white">
        ...
        <Link href="/contact" className="inline-block bg-white text-blue-900 font-bold px-6 py-3 rounded-xl hover:bg-blue-50 transition-colors">
          Contact Us
        </Link>
      </section>
