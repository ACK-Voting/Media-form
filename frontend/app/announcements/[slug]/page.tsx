    ...
    return (
      <div className="min-h-screen bg-white">
        ...
        <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
          ...
          <Link href="/announcements" className="bg-blue-700 text-white px-6 py-3 rounded-xl font-medium hover:bg-blue-800 transition-colors">
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        {/* Back link */}
        <Link href="/announcements" className="inline-flex items-center gap-2 text-blue-600 hover:text-blue-800 text-sm font-medium mb-8 group">
        ...
        {related.length > 0 && (
          <div className="mt-16">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              {related.map((rel) => (
                <Link key={rel.id} href={`/announcements/${rel.slug}`}>
      ...
      <section className="bg-gray-50 border-t border-gray-100 py-12 px-4 text-center">
        ...
        <div className="flex gap-3 justify-center">
          <Link href="/announcements" className="bg-blue-700 text-white font-semibold px-5 py-2.5 rounded-xl hover:bg-blue-800 transition-colors text-sm">
            More Articles
          </Link>
          <Link href="/contact" className="bg-white text-gray-700 font-semibold px-5 py-2.5 rounded-xl border border-gray-200 hover:bg-gray-50 transition-colors text-sm">
            Contact Us
          </Link>
        </div>
      </section>
