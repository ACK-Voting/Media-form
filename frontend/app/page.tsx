...
export default function ACKCathedralMockup() {
    ...
    // Drives the hero's parallax drift only — the navbar tracks its own scroll
    // position now that it lives in the shared Navbar component.
    ...
    return (
        <div className="min-h-screen bg-white">
            {/* Shared with every other page; transparent over the hero here. */}
